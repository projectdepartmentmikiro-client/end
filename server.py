...
# 🔒 Upload & Login Keys (you can move them to Render env vars later)
UPLOAD_PUBLIC_KEY = os.getenv(
    "UPLOAD_PUBLIC_KEY", "pk_42OXvyElpcR89RtMCMWzNlLH2dPYWAL_"
)
UPLOAD_SECRET_KEY = os.getenv(
    "UPLOAD_SECRET_KEY",
    "sk_gjBya/FZDjrloBK4RbBBZ+BK4zUda9fU5MIrnzdFB8MUXbrIkM73vRzrnvwBH0hc",
)
